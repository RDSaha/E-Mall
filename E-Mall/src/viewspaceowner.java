...
/**
 * Servlet implementation class viewspaceowner
 */
@WebServlet("/viewspaceowner")
public class viewspaceowner extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public viewspaceowner() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<!DOCTYPE html>\r\n" + 
        		...
        		"  ");  
        out.println("<form method=\"post\" action=\"choosespace\">\r\n" + 
        		"			<table>\r\n" + 
        		"				<tr>\r\n" + 
        		"					<td>SPACE OWNER ID</td>\r\n" + 
        		"					<td><input type=\"text\" name=\"id\"\r\n" + 
        		"						placeholder=\"Enter Space Owner ID\" required></td>\r\n" + 
        		"				</tr>\r\n" + 
        		"					<td></td>\r\n" + 
        ...
        {  
            ...
            ResultSet rs = stmt.executeQuery("select * from spaceowner");  
            out.println("<table border=1 width=50% height=50%>");  
            out.println("<tr><th>OwnerId</th><th>StoreName</th><th>EmailID</th><tr>");  
            while (rs.next()) 
            {  
                int id = rs.getInt("id"); 
