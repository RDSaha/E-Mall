...
/**
 * Servlet implementation class ownerspaceallotment
 */
@WebServlet("/ownerspaceallotment")
public class ownerspaceallotment extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ownerspaceallotment() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session != null) {
			...
			out.println("<!DOCTYPE html>\r\n" + 
					...
					"<title>E-MALL_SPACE-OWNER-ALLOTMENT</title>\r\n" + 
					...
					"    <a href=\"ownerspaceallotment\" class=\"w3-bar-item w3-button w3-padding w3-blue\">&nbsp; Space Allotment</a>\r\n" + 
					"    <a href=\"revenuepaid\" class=\"w3-bar-item w3-button w3-padding\">&nbsp; Revenue Paid</a>\r\n" + 
