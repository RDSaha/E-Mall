...
/**
 * Servlet implementation class viewbusinessspace_update
 */
@WebServlet("/viewbusinessspace_update")
public class viewbusinessspace_update extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public viewbusinessspace_update() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (session != null) {
			...
			out.println("<!DOCTYPE html>\r\n" + 
					...
					"<title>E-MALL_MARKETING-UPDATE-BUSINESS-SPACE</title>\r\n" + 
					...
					"    <a href=\"viewbusinessspace_update\" class=\"w3-bar-item w3-button w3-padding w3-blue\">&nbsp; Update Cost Of Business Space</a>\r\n" + 
					...
					"    <h5><b> Update Cost Of Business Space</b></h5>\r\n" + 
					"  </header>\r\n" + 
					"\r\n" + 
					"  <div class=\"w3-row-padding w3-margin-bottom\">");
			out.println("<form method=\"post\" action=\"updatebusinessspace\">\r\n" + "			<table>\r\n"
					+ "				<tr>\r\n" + "					<td>SPACE ID</td>\r\n"
					+ "					<td><input type=\"text\" name=\"id\"\r\n"
					+ "						placeholder=\"Enter Space ID\" required></td>\r\n"
					+ "				</tr>\r\n" +

					"<tr><td>COST PER UNIT</td><td><input type=\"text\" name=\"cost\" placeholder=\"Enter Cost Per Unit\" required></td></tr>"
					+
			...
			try {
				...
				out.println(
						"<tr><th>Id</th><th>Space</th><th>Duration</th><th>Rent Type (Unit)</th><th>Cost per Unit</th><tr>");
				while (rs.next()) {
					int id = rs.getInt("id");
					...
					out.println("<tr><td>" + id + "</td><td>" + space + "</td><td>" + duration + "</td><td>" + rent
							+ "</td><td>" + cost + "</td></tr>");
				}
