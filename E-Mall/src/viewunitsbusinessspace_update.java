...
/**
 * Servlet implementation class viewunitsbusinessspace_update
 */
@WebServlet("/viewunitsbusinessspace_update")
public class viewunitsbusinessspace_update extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public viewunitsbusinessspace_update() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session != null) {
			...
			out.println("<!DOCTYPE html>\r\n" + 
					...
					"<title>E-MALL_MARKETING-UPDATE-UNITS(S)-BUSINESS-SPACE</title>\r\n" + 
					...
					"    <a href=\"viewunitsbusinessspace_update\" class=\"w3-bar-item w3-button w3-padding w3-blue\">&nbsp; Update Unit(s) Business Space</a>\r\n" + 
					...
					"    <h5><b> Update Unit(s) Business Space</b></h5>\r\n" + 
					"  </header>\r\n" + 
					"\r\n" + 
					"  <div class=\"w3-row-padding w3-margin-bottom\">\r\n" + 
					"  ");
			out.println("<form method=\"post\" action=\"updateunitsbusinessspace\">\r\n" + "			<table>\r\n"
					+ "				<tr>\r\n" + "					<td>SPACE ID</td>\r\n"
					+ "					<td><input type=\"text\" name=\"id\"\r\n"
					+ "						placeholder=\"Enter Space ID\" required></td>\r\n"
					+ "				</tr>\r\n" +

					"<tr><td> UNIT(S)</td><td><input type=\"text\" name=\"unit\" placeholder=\"Enter Unit(s) Number\" required></td></tr>"
					+
			...
			try {
				...
				ResultSet rs = stmt.executeQuery("select * from unitsspace");
				out.println("<table border=1 width=50% height=50%>");
				out.println(
						"<tr><th>Id</th><th>Space</th><th>Unit(s)</th><tr>");
				while (rs.next()) {
					int id = rs.getInt("id");
					...
					out.println("<tr><td>" + id + "</td><td>" + space + "</td><td>"  + unit + "</td></tr>");
				}
